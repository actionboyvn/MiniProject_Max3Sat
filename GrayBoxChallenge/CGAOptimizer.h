...
inline CGAOptimizer::CGAOptimizer(CMax3SatProblem *pcMax3SatProblem)
{
...
inline CGAOptimizer::~CGAOptimizer()
{
...
inline void CGAOptimizer::vSetCrossoverProbability(double dCrossoverProbability)
{
	d_crossover_probability = dCrossoverProbability;
}

inline void CGAOptimizer::vSetMutationProbability(double dMutationProbability)
{
	d_mutation_probability = dMutationProbability;
}

inline void CGAOptimizer::vInitialize()
{
...
inline void CGAOptimizer::vRunIteration()
{
	for (int i = 0; i < i_population_size; i++) {
...
inline CGAIndividual * CGAOptimizer::pcGetBestFound()
{
